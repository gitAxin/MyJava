...
public class Demo02StringBuffer {
	...
	private static void demo1() {
		...
		//append方法的返回值是原始StringBuffer对象的引用
		System.out.println(sb.toString());		// truehello100
		System.out.println(sb2.toString());		// truehello100
		System.out.println(sb3.toString());		// truehello100
		System.out.println(sb4.toString());		// truehello100
	}
